...
then
cp /newdata/thirdmodif2/from_centos6/MNINonLinear/xfms/acpc2MNILinear.mat "$WD"/xfms/acpc2MNILinear.mat
cp /newdata/thirdmodif2/from_centos6/MNINonLinear/xfms/T1w_acpc_dc_restore_brain_to_MNILinear.nii.gz "$WD"/xfms/T1w_acpc_dc_restore_brain_to_MNILinear.nii.gz
fi
...
then
cp /newdata/thirdmodif2/from_centos6/MNINonLinear/xfms/NonlinearReg.txt "$WD"/xfms/NonlinearReg.txt
cp /newdata/thirdmodif2/from_centos6/MNINonLinear/xfms/NonlinearReg.nii.gz "$WD"/xfms/NonlinearReg.nii.gz
cp /newdata/thirdmodif2/from_centos6/MNINonLinear/xfms/acpc_dc2standard.nii.gz "$WD"/xfms/acpc_dc2standard.nii.gz
cp /newdata/thirdmodif2/from_centos6/MNINonLinear/xfms/NonlinearRegJacobians.nii.gz "$WD"/xfms/NonlinearRegJacobians.nii.gz
cp /newdata/thirdmodif2/from_centos6/MNINonLinear/xfms/IntensityModulatedT1.nii.gz "$WD"/xfms/IntensityModulatedT1.nii.gz
cp /newdata/thirdmodif2/from_centos6/MNINonLinear/xfms/NonlinearIntensities.nii.gz.txt "$WD"/xfms/NonlinearIntensities.nii.gz.txt
cp /newdata/thirdmodif2/from_centos6/MNINonLinear/xfms/NonlinearIntensities.nii.gz "$WD"/xfms/NonlinearIntensities.nii.gz
cp /newdata/thirdmodif2/from_centos6/MNINonLinear/xfms/2mmReg.nii.gz "$WD"/xfms/2mmReg.nii.gz
fi
...
if echo "$IN2" | grep -q "$sub2";
then
cp /newdata/thirdmodif2/from_centos6/MNINonLinear/xfms/standard2acpc_dc.nii.gz "$WD"/xfms/standard2acpc_dc.nii.gz
fi
