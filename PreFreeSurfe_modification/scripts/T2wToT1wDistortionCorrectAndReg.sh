...
for TXw in $Modalities ; do
    ...
    case $DistortionCorrection in
	    ...
	    then
	    cp /newdata/thirdmodif2/from_centos6/T2w/T2wToT1wDistortionCorrectAndReg/Fieldmap2T1w_acpc.mat "$WD"/Fieldmap2T1w_acpc.mat
            cp /newdata/thirdmodif2/from_centos6/T2w/T2wToT1wDistortionCorrectAndReg/Fieldmap2T2w_acpc.mat "$WD"/Fieldmap2T2w_acpc.mat
            cp /newdata/thirdmodif2/from_centos6/T2w/T2wToT1wDistortionCorrectAndReg/Magnitude_warppedT1w2T1w_acpc.nii.gz "$WD"/Magnitude_warppedT1w2T1w_acpc.nii.gz
            cp /newdata/thirdmodif2/from_centos6/T2w/T2wToT1wDistortionCorrectAndReg/Magnitude_warppedT2w2T2w_acpc.nii.gz "$WD"/Magnitude_warppedT2w2T2w_acpc.nii.gz
	    fi	    
...
then
cp /newdata/thirdmodif2/from_centos6/T2w/T2wToT1wDistortionCorrectAndReg/T2w2T1w/T2w_reg_init.mat "$WD"/T2w2T1w/T2w_reg_init.mat
cp /newdata/thirdmodif2/from_centos6/T2w/T2wToT1wDistortionCorrectAndReg/T2w2T1w/T2w_reg.nii.gz "$WD"/T2w2T1w/T2w_reg.nii.gz
cp /newdata/thirdmodif2/from_centos6/T2w/T2wToT1wDistortionCorrectAndReg/T2w2T1w/T2w_reg.mat "$WD"/T2w2T1w/T2w_reg.mat
fi
