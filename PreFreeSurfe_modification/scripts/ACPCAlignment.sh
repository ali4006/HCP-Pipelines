...
then
cp /newdata/thirdmodif2/from_centos6/T1w/ACPCAlignment/roi2std.mat "$WD"/roi2std.mat
cp /newdata/thirdmodif2/from_centos6/T1w/ACPCAlignment/acpc_final.nii.gz "$WD"/acpc_final.nii.gz
else
cp /newdata/thirdmodif2/from_centos6/T2w/ACPCAlignment/roi2std.mat "$WD"/roi2std.mat
cp /newdata/thirdmodif2/from_centos6/T2w/ACPCAlignment/acpc_final.nii.gz "$WD"/acpc_final.nii.gz
fi
