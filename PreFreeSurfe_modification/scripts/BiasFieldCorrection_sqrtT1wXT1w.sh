...
then
cp /newdata/thirdmodif2/from_centos6/T1w/BiasFieldCorrection_sqrtT1wXT1w/T1wmulT2w_brain_norm_modulate_mask.nii.gz "$WD"/T1wmulT2w_brain_norm_modulate_mask.nii.gz
fi
