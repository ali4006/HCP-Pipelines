...
IN="$WD"
sub="T1w"
if echo "$IN" | grep -q "$sub";
then
cp /newdata/thirdmodif2/from_centos6/T1w/BrainExtraction_FNIRTbased/roughlin.mat "$WD"/roughlin.mat
cp /newdata/thirdmodif2/from_centos6/T1w/BrainExtraction_FNIRTbased/T1w_acpc_to_MNI_roughlin.nii.gz "$WD"/T1w_acpc_to_MNI_roughlin.nii.gz
fi
...
IN2="$WD"
sub2="T2w"
if echo "$IN2" | grep -q "$sub2";
then
cp /newdata/thirdmodif2/from_centos6/T2w/BrainExtraction_FNIRTbased/NonlinearReg.txt "$WD"/NonlinearReg.txt
cp /newdata/thirdmodif2/from_centos6/T2w/BrainExtraction_FNIRTbased/NonlinearReg.nii.gz "$WD"/NonlinearReg.nii.gz
cp /newdata/thirdmodif2/from_centos6/T2w/BrainExtraction_FNIRTbased/str2standard.nii.gz "$WD"/str2standard.nii.gz
cp /newdata/thirdmodif2/from_centos6/T2w/BrainExtraction_FNIRTbased/NonlinearRegJacobians.nii.gz "$WD"/NonlinearRegJacobians.nii.gz
cp /newdata/thirdmodif2/from_centos6/T2w/BrainExtraction_FNIRTbased/T2w_acpc_to_MNI_nonlin.nii.gz "$WD"/T2w_acpc_to_MNI_nonlin.nii.gz
else
cp /newdata/thirdmodif2/from_centos6/T1w/BrainExtraction_FNIRTbased/NonlinearReg.txt "$WD"/NonlinearReg.txt
cp /newdata/thirdmodif2/from_centos6/T1w/BrainExtraction_FNIRTbased/NonlinearReg.nii.gz "$WD"/NonlinearReg.nii.gz
cp /newdata/thirdmodif2/from_centos6/T1w/BrainExtraction_FNIRTbased/str2standard.nii.gz "$WD"/str2standard.nii.gz
cp /newdata/thirdmodif2/from_centos6/T1w/BrainExtraction_FNIRTbased/NonlinearRegJacobians.nii.gz "$WD"/NonlinearRegJacobians.nii.gz
cp /newdata/thirdmodif2/from_centos6/T1w/BrainExtraction_FNIRTbased/IntensityModulatedT1.nii.gz "$WD"/IntensityModulatedT1.nii.gz
cp /newdata/thirdmodif2/from_centos6/T1w/BrainExtraction_FNIRTbased/NonlinearIntensities.nii.gz "$WD"/NonlinearIntensities.nii.gz
cp /newdata/thirdmodif2/from_centos6/T1w/BrainExtraction_FNIRTbased/NonlinearIntensities.nii.gz.txt "$WD"/NonlinearIntensities.nii.gz.txt
cp /newdata/thirdmodif2/from_centos6/T1w/BrainExtraction_FNIRTbased/T1w_acpc_to_MNI_nonlin.nii.gz "$WD"/T1w_acpc_to_MNI_nonlin.nii.gz
fi
...
IN3="$WD"
sub3="T2w"
if echo "$IN3" | grep -q "$sub3";
then
cp /newdata/thirdmodif2/from_centos6/T2w/BrainExtraction_FNIRTbased/standard2str.nii.gz "$WD"/standard2str.nii.gz
else
cp /newdata/thirdmodif2/from_centos6/T1w/BrainExtraction_FNIRTbased/standard2str.nii.gz "$WD"/standard2str.nii.gz
fi
